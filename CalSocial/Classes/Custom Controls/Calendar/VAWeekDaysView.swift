...
public struct VAWeekDaysViewAppearance {
    ...
    public init(
        ...
        weekDayTextColor: UIColor = #colorLiteral(red: 0.3102487624, green: 0.5006980896, blue: 0.5967903137, alpha: 1),
...
public class VAWeekDaysView: UIView {
    ...
    private func setupView() {
        ...
        names.enumerated().forEach { index, name in
            ...
            label.textColor = #colorLiteral(red: 0.4391649365, green: 0.4392448664, blue: 0.4391598701, alpha: 1)
