...
public struct VAMonthHeaderViewAppearance {
    ...
    public init(
        monthFont: UIFont = UIFont.systemFont(ofSize: 17),
...
public class VAMonthHeaderView: UIView {
    ...
    public override func layoutSubviews() {
        ...
        monthLabel.frame = CGRect(x: 0, y: 0, width: frame.width - 100, height: frame.height)
    ...
    private func setupView() {
        ...
        monthLabel.textColor = #colorLiteral(red: 0.3102487624, green: 0.5006980896, blue: 0.5967903137, alpha: 1)
