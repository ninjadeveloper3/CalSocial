...
extension UIButton {
    ...
    func addBadge(number: Int, withOffset offset: CGPoint = CGPoint.zero, andColor color: UIColor = UIColor.appThemeColor(), andFilled filled: Bool = true, position: BadgePosition = .topRight) {
