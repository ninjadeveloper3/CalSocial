...
class TSAPIClient: SessionManager {
    ...
    func serverRequest(_ methodName: String, parameters: [String : AnyObject]? , methods: HTTPMethod, headers: [String : String]?, completionBlock: @escaping TSAPIClientCompletionBlock) -> Request {
        ...
        if methods == .post {
            ...
            let request = self.request(url!, method: .delete , parameters: parameters, encoding: URLEncoding.default, headers: headers)
                .validate(statusCode: 200..<600)
                .responseJSON { response in
            ...
            return request
                ...
                let request = self.request(url!, method: .put , parameters: parameters, encoding: URLEncoding.default, headers: headers)
                    .validate(statusCode: 200..<600)
                    .responseJSON { response in
...
/*
    func serverMultiFormRequest(_ methodName: String, param: [String : AnyObject]?, image: UIImage?, imageName: String, completionBlock: @escaping TSAPIClientCompletionBlock) {
        ...
        }, to: myURL as! URLConvertible, encodingCompletion: { (result) in
            // code
        })
